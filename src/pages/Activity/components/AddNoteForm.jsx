...
const AddNoteForm = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto">
            ...
            >
                <div
                    className="relative bg-white w-[90%] max-w-md rounded-2xl px-5 pb-5 z-50 shadow-xl animate-in fade-in zoom-in-95 duration-200"
                ...
                >
                    <div className="relative flex items-end justify-center mb-4">
                        <div className="flex items-center justify-center gap-1.5 bg-primary w-37.5 h-7 rounded-b-md shadow-md">
                            ...
                            <span className='font-inter font-medium text-h5 leading-none text-white'>{today}</span>
                        </div>
                        <Button className="absolute right-0 top-2 p-1 hover:bg-gray-100 rounded-full transition-colors" onClick={() => setCatatan()}>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <span className="text-h6 font-inter text-gray-400 font-medium uppercase tracking-wider text-center">Live Preview</span>
                        ...
                        <form onSubmit={handleAddNote}>
                            ...
                            <div className="flex flex-col gap-4 my-3">
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    <InputLabel label="Nama Status" variant="white" placeholder="Cth: Membaik, Pusing..." className="text-h4" value={selectedStatus} onChange={(e) => setSelectedStatus(e.target.value)} />
                                </div>

                                {/* Color Selection */}
                                <div className="grid grid-cols-1 gap-2">
                                    <span className="text-h4 font-inter font-semibold">Warna Label</span>
                                    <div className="grid grid-cols-1 gap-2">
                                        <label className="flex items-center gap-2 cursor-pointer p-2 rounded-lg hover:bg-green-50 transition-colors border border-transparent hover:border-green-100 has-[:checked]:bg-green-50 has-[:checked]:border-green-200">
                                            ...
                                            />
                                            <span className='font-inter text-h5 text-gray-700'>Hijau</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer p-2 rounded-lg hover:bg-blue-50 transition-colors border border-transparent hover:border-blue-100 has-[:checked]:bg-blue-50 has-[:checked]:border-blue-200">
                                            ...
                                            />
                                            <span className='font-inter text-h5 text-gray-700'>Biru</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer p-2 rounded-lg hover:bg-yellow-50 transition-colors border border-transparent hover:border-yellow-100 has-[:checked]:bg-yellow-50 has-[:checked]:border-yellow-200">
                                            ...
                                            />
                                            <span className='font-inter text-h5 text-gray-700'>Kuning</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                {/* Note Input */}
                                <div className="grid grid-cols-1 gap-2">
                                    <span className="text-h4 font-inter font-semibold">Catatan</span>
                                    <textarea
                            ...
                            <Button variant="primary" type='submit' size="full" className="py-2.5 text-h5 font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98] transition-all">
                                Simpan Catatan
                            </Button>
                        </form>
                    </div>
