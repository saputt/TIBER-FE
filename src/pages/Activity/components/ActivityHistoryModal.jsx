        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-300">
            <Card className="bg-white w-full max-w-sm rounded-lg p-5 shadow-xl relative animate-in zoom-in-95 duration-300 flex flex-col">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-h5 font-medium text-gray-600">Minggu {weekNumber}</span>
                    <button onClick={handleNextWeek} className="p-2 text-primary hover:bg-green-50 rounded-full">
                                ...
                                return (
                                    <div className="flex gap-3 items-center" key={index}>
                                        ...
                                        <div className="flex flex-col flex-1 justify-center">
                                            <p className="font-semibold text-h6 text-gray-900">
                                                {formatRelativeDateID(item.date)}
                                            </p>
                                            <p className="text-h7 text-gray-500">{statusText}</p>
                                        </div>
                                    </div>
                                );
                            })
